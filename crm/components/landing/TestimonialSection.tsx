...
// Removed external imports for data and type
...
const testimonialsData: Testimonial[] = [
  {
    name: "Ahmad Basit",
    title: "Chief Operations Officer, Synergy Digital",
    quote:
      "Implementing this CRM cut our client onboarding time in half. The custom reporting features give us actionable insights daily, which has been crucial for our scalability.",
    avatarUrl:
      "https://placehold.co/100x100/34D399/ffffff?text=AB",
  },
  {
    name: "Zeeshan Ali",
    title: "Product Manager, Future Solutions",
    quote:
      "The seamless integration with our existing tools was a huge win. The platform's flexibility allowed us to model our unique workflows perfectly, leading to immediate productivity gains.",
    avatarUrl:
      "https://placehold.co/100x100/34D399/ffffff?text=ZA",
  },
  {
    name: "Ahmad Hassan",
    title: "Founder & CEO, Apex Consulting",
    quote:
      "As a consulting firm, client relationship management is everything. This CRM provides a unified view of every interaction, ensuring nothing falls through the cracks and elevating our client service quality.",
    avatarUrl:
      "https://placehold.co/100x100/34D399/ffffff?text=AH",
  },
];
...
export function TestimonialSection() {
  ...
  // Changed reference to internal data
  ...
  useEffect(() => {
    // This is set to 'next', which achieves the left-to-right scrolling effect (incrementing index)
  ...
  return (
    ...
    >
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-emerald-500/10 blur-3xl" />

      <div className="relative container mx-auto px-6 max-w-6xl text-center">
        {/* Heading updated for CRM focus */}
        <div className="max-w-3xl mx-auto mb-16">
          <p className="text-sm font-semibold uppercase tracking-widest text-emerald-400 mb-3">
            Client Success Stories
          </p>
          <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4 leading-tight">
            See How Our CRM Transforms Your Business
          </h2>
          <p className="text-lg text-gray-400">
            From Sales to Support, our clients share how our platform delivered measurable results and simplified their operations.
          </p>
        </div>
