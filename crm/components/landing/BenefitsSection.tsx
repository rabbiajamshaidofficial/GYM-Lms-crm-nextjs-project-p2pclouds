...
import { BenefitItem } from "@/types/allTypes";
      ...
      <div className="relative container mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-lg text-gray-400">
            P2PClouds CRM simplifies every customer interaction, boosting sales efficiency, improving retention, and giving you actionable business insights.
          </p>
        </motion.div>
        ...
        <div className="grid gap-10 md:grid-cols-3">
          {benefitsData.map((benefit: BenefitItem, index: number) => (
            ...
            >
              <Card 
                // ⭐ ADDED MINIMUM HEIGHT AND FLEX LAYOUT FOR STATIC SIZE & ALIGNMENT ⭐
                className="relative group border border-white/10 bg-white/5 backdrop-blur-md rounded-3xl shadow-[0_0_30px_rgba(16,185,129,0.15)] hover:shadow-[0_0_40px_rgba(16,185,129,0.3)] transition-all duration-500 p-8 flex flex-col justify-between min-h-[350px]"
              >
