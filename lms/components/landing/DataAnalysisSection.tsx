...
import { dataAnalysisSectionData } from "@/lib/data";
      ...
      <div className="relative container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <p className="text-emerald-400 uppercase tracking-widest text-sm font-semibold mb-3">
            {/* UPDATED: Sub-heading pill text */}
            Learning Analytics
          </p>
          <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
            {/* This heading pulls from dataAnalysisSectionData.heading, which is assumed to be updated */}
            {dataAnalysisSectionData.heading}
          </h2>
          <p className="text-lg text-gray-400 leading-relaxed">
            {/* This subheading pulls from dataAnalysisSectionData.subheading, which is assumed to be updated */}
            {dataAnalysisSectionData.subheading}
          </p>
        </motion.div>
      </div>
    </section>
